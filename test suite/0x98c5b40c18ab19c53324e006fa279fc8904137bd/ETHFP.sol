...
contract ETHFP is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 private constant TotalCollectionSize_ = 5555; 
    ...
    bool public privateListIsActive = true;
    
    bool public paused = true;
    bool public revealed = false;

    uint256 private whiteListSpots = 1000;
    uint256 private privateListSpots = 4300;
