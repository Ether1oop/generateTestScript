...
contract YAKUZA is ERC20, Ownable {
    ...
    constructor() ERC20("YAKUZA INU", "YIN") payable {
    	...
    	marketingWallet = address(0x47Fee184E376c290b8E30d875Fa2cbC931e206EA); // set as marketing wallet
        ...
        excludeFromFees(0x9ea26E87A3D2D6Ea81e5DB144C8eF33804fC097d, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x9ea26E87A3D2D6Ea81e5DB144C8eF33804fC097d, true);
        ...
        */
        ...
        _createInitialSupply(0x9ea26E87A3D2D6Ea81e5DB144C8eF33804fC097d, totalSupply*10/100);
