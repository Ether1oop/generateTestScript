...
describe("ConvexToken",function(){
	...
	describe("approve",function(){
		it("testing approve",async function(){
			...
			await _contract.connect(account0).approve("0xB576491F1E6e5E62f1d8F26062Ee822B40B0E0d4","0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
		});
	});
});