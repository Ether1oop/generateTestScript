...
describe("NiftyBuilderInstance",function(){
	async function deployOneYearLockFixture(){
		...
		const _contract = await _Contract.deploy("Olive Allen's The Unbearables","OLIVEALLENSTHEUNBEARABLES","1","7",["80","65","50","35","20","12","3"],"https://api.niftygateway.com/bear_with_me/","Olive");
